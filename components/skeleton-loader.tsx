...
export function SkeletonListItem({ delay = 0 }: { delay?: number }) {
  return (
    <motion.div
      ...
      transition={{ delay, duration: 0.3 }}
      className="flex items-center gap-4 p-4 border-b border-slate-100 dark:border-slate-800 last:border-0"
    >
...
export function SkeletonSidebar() {
  return (
    <div className="fixed left-0 top-0 h-screen w-[80px] md:w-[260px] bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-r border-slate-200 dark:border-slate-800 z-50 p-4">
      {/* Logo Section */}
...
export function SkeletonCommandCenter() {
  return (
    <div className="min-h-screen bg-[#F9FAFB] dark:bg-slate-950 ml-0 md:ml-[80px] pt-[60px] md:pt-0">
      <div className="p-4 md:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-7 gap-4 mb-6">
          <SkeletonStatCard delay={0.1} />
          <SkeletonStatCard delay={0.15} />
          <SkeletonStatCard delay={0.2} />
          <SkeletonStatCard delay={0.25} />
          <SkeletonStatCard delay={0.3} />
        </div>

        {/* Command Pulse Alert Strip */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[...Array(4)].map((_, i) => (
            <SkeletonCard key={i} delay={0.1 * (i + 1)} className="p-3" />
          ))}
        </div>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-3 space-y-4">
            <SkeletonCard delay={0.2} className="min-h-[300px]" />
            <SkeletonCard delay={0.3} />
          </div>

          {/* Middle Column */}
          <div className="col-span-12 lg:col-span-6 space-y-4">
            <SkeletonCard delay={0.25} className="min-h-[400px]" />
          </div>

          {/* Right Column */}
          <div className="col-span-12 lg:col-span-3 space-y-4">
            <SkeletonCard delay={0.3} className="min-h-[300px]" />
