...
// Sample history data
const sampleHistory: FinancialEntry[] = [
    {
        id: "1",
        date: "Today",
        uloomxIncome: 125000,
...
export default function AccountsPage() {
    ...
    const handleSubmit = async () => {
        if (!uloomxIncome && !usthadIncome) return;
    ...
    return (
        <div className="min-h-screen bg-[#f9fafb] pb-28">
            ...
            <div className="max-w-[450px] mx-auto">
                {/* Mobile Header */}
                <div className="bg-white px-4 pt-4 pb-6 rounded-b-[24px] shadow-sm">
                ...
                {/* Full-width Transmit Button - Above Bottom Nav */}
